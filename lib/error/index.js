 ...
 * Helps to use only one class or constructor several types of error avoiding
 * mantains several classes with the same behavior
 */
class ExpError extends Error {
	 ...
	 * @param {object}  options Object with additionals properties for the error description. Object could have any custom additional property but `errorObject` it's usefully to set error from external source
	 */
