...
class ExpError extends Error {
	...
	constructor(type = null, httpstatus = null, message='', options={}){
		...
		// TODO: Replace with the option collector used for all the expObject
		const { errorObject, adheaders, ...props } = options;
		this._errorObject = errorObject || {}; // Original Error from another source
