...
class ExpError extends Error {
	...
	/**
	 * Return a JSON representation of the error to be simple and common for HTTP response and the client
	 * can interpret it really easy. Additional header will come in the HTTP headers so it is not required to set a flag to expose them
