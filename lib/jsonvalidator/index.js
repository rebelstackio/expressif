...
class JSONValidator {
	...
	addSchema ( schemas, key ) {
		switch (true) {
			case ( schemas instanceof Array ) : super.addSchema(schemas); break;
			case ( typeof schemas === 'string' ) : super.addSchema( JSON.parse(schemas), key ); break;
			case ( typeof schemas === 'object' ) :  super.addSchema(schemas); break;
